...
import { getalljobInterface, getApplicationPayload, IApplicantDetails, IChatpayload, IGetUserApplicationResponse, IJobFilterParams, IUpdateStatusPayload } from "utils/types/types";
